...
test('Returns number of documents not starting with "BC" or "CAD"', () => {
  expect(countHits(catalog)).toEqual(10)
})

test('Returns number of documents not starting with "BC" or "CAD" in alternative format', () => {
  expect(countHits(alternativeCatalog)).toEqual(4)
})
