...
test('Returns documents not starting with "BC" or "CAD"', () => {
  expect(extractDocuments(catalog)).toEqual([
    'Fincke 2003-2004 The Babylonian Texts of Nineveh AfO 50',
    '401239',
    'RlA 09 Nab - Nuzi 1998-2000',
    '0(6)',
    '0(7)',
    'ABL 4-6',
    'CADShoudlBeAHit',
    'cadShoudlBeAHit',
    '[CAD D, E, I] Edzard 1961 Rv CAD D, E, I ZA 54',
    'Johns 1898 Assyrian Deeds and Documents ADD 1-3'
  ])
})
