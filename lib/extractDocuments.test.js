...
test('Returns documents not starting with "BC" or "CAD"', () => {
  expect(extractDocuments(catalog)).toEqual([
    new Reference('Fincke 2003-2004 The Babylonian Texts of Nineveh AfO 50', [38]),
    new Reference('0(7)', [7, 10]),
    new Reference('ABL 4-6', [97, 98, 127]),
    new Reference('CADShoudlBeAHit', [208]),
    new Reference('cadShoudlBeAHit', [208]),
    new Reference('[CAD D, E, I] Edzard 1961 Rv CAD D, E, I ZA 54', [1])
  ])
})
